...
(function(vue) {
  ...
  const _sfc_main$8 = {
    ...
    setup(__props, { expose: __expose }) {
      ...
      const handleLogin = () => {
        if (isClick)
          return;
        formatAppLog("log", "at pages/login/login.vue:30", "1");
        isClick = true;
        setTimeout(() => {
          isClick = false;
        }, 5e3);
      ...
      const __returned__ = { toastRef, link, get isClick() {
        ...
        isClick = v;
      }, handleLogin, ref: vue.ref, RightToast };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
    }
  };
  ...
  const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6], ["__scopeId", "data-v-d31e1c47"], ["__file", "D:/code_tools/projects/front/flip-card-app/uni_modules/uni-icons/components/uni-icons/uni-icons.vue"]]);
  const _sfc_main$6 = {};
  ...
  const _sfc_main$5 = {
    ...
    setup(__props, { expose: __expose }) {
      ...
      const __returned__ = { activeIndex, btnList, handleClick, openSetting, ref: vue.ref, TopBar };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
    }
  };
  ...
  const PagesRootRoot = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__file", "D:/code_tools/projects/front/flip-card-app/pages/root/root.vue"]]);
  const _sfc_main$3 = {
    name: "UniTag",
    emits: ["click"],
    props: {
  ...
  function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
    return $options.showTag ? (vue.openBlock(), vue.createElementBlock(
      "text",
      {
        key: 0,
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__scopeId", "data-v-1f94d070"], ["__file", "D:/code_tools/projects/front/flip-card-app/uni_modules/uni-tag/components/uni-tag/uni-tag.vue"]]);
  const _sfc_main$2 = {
    __name: "sendMsg",
    setup(__props, { expose: __expose }) {
      const codeList = vue.ref(["1", "2", "3", "❤", ""]);
      const activeIndex = vue.ref(0);
      const handleClick = (index) => {
        activeIndex.value = index;
      };
      ...
      const __returned__ = { codeList, activeIndex, handleClick, inputChar, deleteChar, ref: vue.ref, reactive: vue.reactive, TopBar };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
    }
  };
    ...
    return vue.openBlock(), vue.createElementBlock(
      ...
      [
        ...
        vue.createElementVNode("view", { class: "code-wrapper" }, [
          vue.createVNode(_component_uni_tag, { text: "1" }),
          vue.createElementVNode("view", { class: "code-container" }, [
            (vue.openBlock(true), vue.createElementBlock(
              ...
              vue.renderList($setup.codeList, (item, index) => {
                return vue.openBlock(), vue.createElementBlock("view", {
                  key: index,
                  class: vue.normalizeClass(["code-item", { active: $setup.activeIndex === index }]),
                  onClick: ($event) => $setup.handleClick(index)
                }, [
                  item ? (vue.openBlock(), vue.createElementBlock(
                    "text",
                    {
                      key: 0,
                      class: "code-text"
                    ...
                    {
                      key: 1,
                      class: vue.normalizeClass(["cursor", { blink: $setup.activeIndex === index }])
                    },
                    null,
                    2
                    /* CLASS */
  ...
  const PagesCalcGameCalcGame = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "D:/code_tools/projects/front/flip-card-app/pages/calcGame/calcGame.vue"]]);
